...
| **Compression Ratio** | Original length / Summary length           |  2-5x  |
...
5. **Set up API Keys**
   ...
   Get your API key here: Groq Console
...
Select quality and chunk overlap settings in the sidebar

Click "Generate Summary"

View the well-structured summary with real-time progress

Review quality metrics (Cosine Similarity, Compression, Coverage, Redundancy)
...
Zero Redundancy	No duplicate information in summaries
📈 Performance Results
Document Type	Cosine Similarity	Compression Ratio	Redundancy
Research Paper (BERT)	0.866	3.1x	0.005
Business Document (Five Forces)	0.778	1.5x	0.000
Management Principles	0.789	2.7x	0.000
NLP Textbook Chapter	0.719	1.6x	0.064
🔑 API Keys Required
Service	Purpose	Get it at
Groq	LLM inference for summarization	https://console.groq.com
📋 Requirements
text
streamlit>=1.28.0
PyMuPDF>=1.23.0
